...
void checkONbtn();
void checkOFFbtn();
void menu1();                                           //Função do menu1
void menu2();                                           //Função do menu2
void menu3();                                           //Função do menu3
void menu4();                                           //Função do menu4
void menu5();                                           //Função do menu5
...
long OnTime = 900000;           // milliseconds of on-time

long OffTime = 900000;          // milliseconds of off-time
...
void dispMenu()                                         //Mostra o menu atual
{
  switch (menu)                                      //Controle da variável menu
  {
    ...
    case 0x04:                                       //Caso 4
      ...
      break;                                         //break
    case 0x05:                                       //Caso 5
      menu5();                                       //Chama função para irrigar as camas de cultivos
...
void menu2()                                            //Função genérica para o menu 2
{
  lcd.setCursor(0, 0);
  lcd.print("mode - 1");
  lcd.setCursor(0, 1);
  ...
  switch (estadoSTR)                                     //Controle do set1
  {
    case 0x01:                                        //Caso 1
      ...
      lcd.setCursor(0, 1);
      lcd.print("fill the tank");
      lcd.setCursor(12, 0);                     //Posiciona cursor na coluna 12, linha 0
...
void GetsensorReadings() {
  ...
  if ( (millis() - delayEC) < 60000) {
    ...
    GetPh();
    PrintReadingsSerial();  // Cals Print routine [below main loop]
